...
Subreddits are now managed live using Discord slash commands. Changes are stored persistently in subreddits.py (not subreddits.json), and are available immediately—no need to restart the bot!
**Add a Subreddit**
     ```
